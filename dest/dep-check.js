...
var _user$project$Model$makePackageGraph = function (_p0) {
	...
	var directoriesWithIndex = A2(
		...
		F2(
			function (id, _p2) {
				var _p3 = _p2;
				return {ctor: '_Tuple2', _0: id, _1: _p3._0};
			}),
		_elm_lang$core$Dict$toList(_p1._0));
	var dirToId = _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$map,
			function (_p4) {
				var _p5 = _p4;
	...
	var edges = A2(
		...
		function (_p6) {
			...
			var _p8 = {
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$Dict$get, _p7._0._0, dirToId),
				_1: A2(_elm_lang$core$Dict$get, _p7._0._1, dirToId)
			};
			if (((_p8.ctor === '_Tuple2') && (_p8._0.ctor === 'Just')) && (_p8._1.ctor === 'Just')) {
				return _elm_lang$core$Maybe$Just(
					A3(_elm_community$graph$Graph$Edge, _p8._0._0, _p8._1._0, _p7._1));
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		},
	...
	var nodes = A2(
		...
		function (_p9) {
			var _p10 = _p9;
			return A2(_elm_community$graph$Graph$Node, _p10._0, _p10._1);
		},
		directoriesWithIndex);
	return A2(_elm_community$graph$Graph$fromNodesAndEdges, nodes, edges);
};
var _user$project$Model$makeModuleGraph = function (deps) {
	var depsWithId = A2(
		_elm_lang$core$List$indexedMap,
		F2(
			function (v0, v1) {
	...
	var dict = _elm_lang$core$Dict$fromList(
		A2(
			...
			function (_p11) {
				var _p12 = _p11;
				return {ctor: '_Tuple2', _0: _p12._1._0, _1: _p12._0};
			},
			depsWithId));
	var _p13 = A3(
		_elm_lang$core$List$foldl,
...
var _user$project$Model$sort = function (graph) {
	return A2(
		_elm_lang$core$List$map,
		function (nodeContext) {
			return nodeContext.node.label;
		},
...
var _user$project$Model$sortModuleAgain = F2(
	function (dirNames, modNames) {
		var dict = A3(
			_elm_lang$core$List$foldr,
			F2(
				function (mod, dict) {
					var dir = _user$project$Model$dirName(mod);
					return A3(
						_elm_lang$core$Dict$update,
						dir,
						function (value) {
...
var _user$project$Model$indexOf = F2(
	function (a, list) {
...
var _user$project$Model$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {deps: a, dirLabelLength: b, dirNames: c, dirBody: d, modLabelLength: e, groupedModNames: f, modBody: g, hover: h};
	});
var _user$project$Model$LeaveCell = {ctor: 'LeaveCell'};
var _user$project$Model$EnterCell = F2(
	function (a, b) {
		return {ctor: 'EnterCell', _0: a, _1: b};
	});

var _user$project$Styles$px = function (num) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(num),
		'px');
};
var _user$project$Styles$cellWidth = 30;
var _user$project$Styles$row = F2(
	function (labelLength, length) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'display', _1: 'flex'},
				{ctor: '_Tuple2', _0: 'border-bottom', _1: 'solid 1px #fff'},
				{
				ctor: '_Tuple2',
				_0: 'width',
				_1: _user$project$Styles$px(labelLength + (length * _user$project$Styles$cellWidth))
			}
			]);
	});
var _user$project$Styles$colHeadText = function (labelLength) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			...
			_1: A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Styles$px(labelLength),
					')'))
		},
			...
			ctor: '_Tuple2',
			_0: 'width',
			_1: _user$project$Styles$px(labelLength)
		},
			{
			ctor: '_Tuple2',
			_0: 'height',
			_1: _user$project$Styles$px(_user$project$Styles$cellWidth)
		},
...
var _user$project$Styles$cellBgColor = function (state) {
	var _p0 = state;
	switch (_p0.ctor) {
		case 'Exists':
			return '#6d4';
		...
		case 'Hovered':
			return '#bcd';
		default:
			return _p0._0 ? '#ddd' : '#eee';
	}
};
var _user$project$Styles$cell = function (state) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			...
			ctor: '_Tuple2',
			_0: 'background-color',
			_1: _user$project$Styles$cellBgColor(state)
		},
			{ctor: '_Tuple2', _0: 'box-sizing', _1: 'border-box'},
			{ctor: '_Tuple2', _0: 'border-right', _1: 'solid 1px #fff'}
		]);
};
var _user$project$Styles$headerBgColor = function (hover) {
	return hover ? '#abc' : '#ddd';
};
var _user$project$Styles$rowColHead = function (labelLength) {
	return _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'background-color',
			_1: _user$project$Styles$headerBgColor(false)
		},
			{
			ctor: '_Tuple2',
			_0: 'width',
...
var _user$project$Styles$rowHead = F2(
	function (hover, labelLength) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'background-color',
				_1: _user$project$Styles$headerBgColor(hover)
			},
				{
				ctor: '_Tuple2',
				_0: 'width',
...
var _user$project$Styles$colHead = F2(
	function (hover, labelLength) {
		return _elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$Styles$None = function (a) {
	return {ctor: 'None', _0: a};
};
var _user$project$Styles$Hovered = {ctor: 'Hovered'};
var _user$project$Styles$Exists = {ctor: 'Exists'};
var _user$project$Styles$Warning = {ctor: 'Warning'};

var _user$project$View$cellViewHelp = F3(
	function (cellState, tableName, _p0) {
		var _p1 = _p0;
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Styles$cell(cellState)),
					_elm_lang$html$Html_Events$onMouseEnter(
					A2(
						_user$project$Model$EnterCell,
						tableName,
						{ctor: '_Tuple2', _0: _p1._0, _1: _p1._1})),
					_elm_lang$html$Html_Events$onMouseLeave(_user$project$Model$LeaveCell)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(_p1._2)
				]));
	});
var _user$project$View$cellView = F5(
	function (isHovered, tableName, rowIndex, colIndex, _p2) {
		var _p3 = _p2;
		var _p4 = _p3._1;
		var text = _p4 ? '1' : '0';
		var key = A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'-',
					_elm_lang$core$Basics$toString(colIndex))));
		var cellState = (_p4 && (_elm_lang$core$Native_Utils.cmp(rowIndex, colIndex) > 0)) ? _user$project$Styles$Warning : (_p4 ? _user$project$Styles$Exists : (A2(
			isHovered,
			tableName,
			{ctor: '_Tuple2', _0: rowIndex, _1: colIndex}) ? _user$project$Styles$Hovered : _user$project$Styles$None(
			_elm_lang$core$Native_Utils.eq(
				A2(_elm_lang$core$Basics_ops['%'], _p3._0._1 + _p3._0._0, 2),
				1))));
		var html = A4(
			_elm_lang$html$Html_Lazy$lazy3,
			_user$project$View$cellViewHelp,
			cellState,
			tableName,
			{ctor: '_Tuple3', _0: rowIndex, _1: colIndex, _2: text});
		return {ctor: '_Tuple2', _0: key, _1: html};
	});
var _user$project$View$bodyRowHeadView = F5(
	function (isHovered, tableName, labelLength, rowIndex, mod) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(
					A2(
						_user$project$Styles$rowHead,
						A2(
							isHovered,
							tableName,
							{ctor: '_Tuple2', _0: rowIndex, _1: -1}),
						labelLength)),
					_elm_lang$html$Html_Events$onMouseEnter(
					A2(
						_user$project$Model$EnterCell,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(mod)
				]));
	});
var _user$project$View$bodyRowView = F6(
	function (isHovered, tableName, labelLength, length, rowIndex, _p5) {
		var _p6 = _p5;
		var tail = A2(
			_elm_lang$core$List$indexedMap,
			A3(_user$project$View$cellView, isHovered, tableName, rowIndex),
			_p6._1);
		var head = {
			ctor: '_Tuple2',
			_0: A2(
				...
				A2(
					...
					_elm_lang$core$Basics$toString(rowIndex),
					'-head')),
			_1: A5(_user$project$View$bodyRowHeadView, isHovered, tableName, labelLength, rowIndex, _p6._0)
		};
		return A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$style(
					A2(_user$project$Styles$row, labelLength, length))
				]),
			A2(_elm_lang$core$List_ops['::'], head, tail));
	});
var _user$project$View$bodyView = F4(
	function (isHovered, tableName, labelLength, mods) {
		return A2(
			_elm_lang$core$List$indexedMap,
			A4(
				_user$project$View$bodyRowView,
				isHovered,
				tableName,
				labelLength,
				_elm_lang$core$List$length(mods)),
			mods);
	});
var _user$project$View$rowColheadView = function (labelLength) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$style(
				_user$project$Styles$rowColHead(labelLength))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$View$headRowView = F4(
	function (isHovered, tableName, labelLength, imps) {
		return A3(
			_elm_lang$html$Html_Keyed$node,
			'div',
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						labelLength,
						_elm_lang$core$List$length(imps)))
				]),
			A2(
				_elm_lang$core$List_ops['::'],
				{
					ctor: '_Tuple2',
					_0: 'cell-head-head',
					_1: _user$project$View$rowColheadView(labelLength)
				},
				A2(
					_elm_lang$core$List$indexedMap,
					F2(
						function (colIndex, imp) {
							var key = A2(
								_elm_lang$core$Basics_ops['++'],
								'cell-head-',
								_elm_lang$core$Basics$toString(colIndex));
							var state = A2(
								isHovered,
								tableName,
								{ctor: '_Tuple2', _0: -1, _1: colIndex});
							var html = A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$style(
										A2(_user$project$Styles$colHead, state, labelLength)),
										_elm_lang$html$Html_Events$onMouseEnter(
										A2(
											_user$project$Model$EnterCell,
											tableName,
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$style(
												_user$project$Styles$colHeadText(labelLength))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(imp)
											]))
									]));
							return {ctor: '_Tuple2', _0: key, _1: html};
						}),
...
var _user$project$View$isHovered = F3(
	function (hoverState, tableName, _p7) {
		var _p8 = _p7;
		var _p13 = _p8._0;
		var _p12 = _p8._1;
		var _p9 = hoverState;
		if (_p9.ctor === 'Just') {
			...
			var _p10 = _p9._0._1._1;
			return _elm_lang$core$Native_Utils.eq(_p9._0._0, tableName) && (_elm_lang$core$Native_Utils.eq(_p13, -1) ? _elm_lang$core$Native_Utils.eq(_p10, _p12) : (_elm_lang$core$Native_Utils.eq(_p12, -1) ? _elm_lang$core$Native_Utils.eq(_p11, _p13) : (_elm_lang$core$Native_Utils.eq(_p11, _p13) || _elm_lang$core$Native_Utils.eq(_p10, _p12))));
		} else {
			return false;
		}
	});
var _user$project$View$tableView = F5(
	function (hoverState, tableName, labelLength, names, body) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(
				_elm_lang$core$List_ops['::'],
				A4(
					_user$project$View$headRowView,
					_user$project$View$isHovered(hoverState),
					tableName,
					labelLength,
					names),
				A4(
					_user$project$View$bodyView,
					_user$project$View$isHovered(hoverState),
					tableName,
					labelLength,
					body)));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Directories')
					])),
				A5(_user$project$View$tableView, model.hover, 'directories', model.dirLabelLength, model.dirNames, model.dirBody),
				A2(
				_elm_lang$html$Html$h2,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Modules')
					])),
				A5(_user$project$View$tableView, model.hover, 'modules', model.modLabelLength, model.groupedModNames, model.modBody)
			]));
};

var _user$project$DepCheck$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'EnterCell') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
						...
						hover: _elm_lang$core$Maybe$Just(
							{
								ctor: '_Tuple2',
								_0: _p0._0,
								_1: {ctor: '_Tuple2', _0: _p0._1._0, _1: _p0._1._1}
							})
					}),
				_elm_lang$core$Native_List.fromArray(
					[]));
...
var _user$project$DepCheck$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: function (flags) {
				return _user$project$Model$init(flags.deps);
			},
			update: _user$project$DepCheck$update,
...
var _user$project$DepCheck$Flags = function (a) {
	return {deps: a};
};

var Elm = {};
Elm['DepCheck'] = Elm['DepCheck'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['DepCheck'], 'DepCheck', typeof _user$project$DepCheck$main === 'undefined' ? null : _user$project$DepCheck$main);
